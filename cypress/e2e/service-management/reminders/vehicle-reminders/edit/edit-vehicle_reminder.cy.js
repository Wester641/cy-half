...
describe("Test edit vehicle-reminder", () => {
  ...
  it("should edit vehicle-reminder on production", () => {
    cy.loginWith(email, password);
    cy.url().should("include", URLs.units);

    cy.visit(URLs.vehicleRemindersPage);
    // cy.wait(3000);
    ...
    cy.get(Selectors.description)
      .clear()
      .type(
        `This vehicle-reminder was edited on ${today}, at ${time} by Zafar`
      );
