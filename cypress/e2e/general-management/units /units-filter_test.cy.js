describe("Checking All filters in Units section", () => {
  ...
  it("should check all filters without search filter", () => {
    ...
    cy.wait(1500);
    cy.url().should("include", "/units?page=1&filter=is_assigned");
    ...
    // cy.wait(1500);
    cy.url().should("include", "/units?page=1&filter=is_unassigned");
    ...
    // cy.wait(1500);
    cy.url().should("include", "/units?page=1&filter=is_archived");
